...
setup(
    ...
    entry_points={
        ...
        'yolov8_node = self_driving_car_pkg.yolo_node:main',
        'lane_detection_node = self_driving_car_pkg.line_detect_node:main',
        'trafficlight_detection_node = self_driving_car_pkg.trafficlight_detection_node:main',
        'planning_node = self_driving_car_pkg.planning_node:main',
        'trigger_node = self_driving_car_pkg.trigger_node:main',
