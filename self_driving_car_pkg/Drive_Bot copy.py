...
class Control:
    ...
    def follow_Lane(self,Max_Sane_dist,distance,curvature , Mode , Tracked_class):
        ...
        if( (distance > Max_Sane_dist) or (distance < (-1 * Max_Sane_dist) ) ):
            ...
            CarTurn_angle = (0.65*Turn_angle_interpolated) + (0.5*curvature) # 0.35 => 0.5
    ...
    def Obey_LeftTurn(self,Angle,Speed,Mode,Tracked_class):
        ...
        if (Tracked_class == "left_turn"):
            ...
            if ( (self.prev_Mode_LT =="Detection") and (Mode=="Tracking")):
                ...
                print(f"left turn!! Left_turn_iterations: {self.Left_turn_iterations} | Frozen_Angle: {self.Frozen_Angle}")
                ...
                if(self.Left_turn_iterations==250):
                    ...
                    self.Left_turn_iterations = 0
                    self.Frozen_Angle = 0
                    print("Turn finished!!!", self.Activat_LeftTurn, self.Left_turn_iterations)
    ...
    def drive_car(self,Current_State,Inc_TL,Inc_LT):
        ...
        [Distance, Curvature, frame_disp, Action] = Current_State
...
class Car:
    ...
    def driveCar(self,Current_State):
        ...
        Angle,Speed = self.Control_.drive_car(Current_State,self.Inc_TL,self.Inc_LT)
